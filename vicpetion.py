...
from tensorflow.keras.applications.inception_v4 import InceptionV4
import cv2
...
from tensorflow.keras.applications.inception_v3 import InceptionV4

pre_trained_model = InceptionV4(
...
model.save('fashion_image_classification_model4.h5')